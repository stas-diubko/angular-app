...
import { RegisterModel } from 'src/app/shared/models/registration-model';
...
export class RegistrationComponent implements OnInit {
  ...
  registration(): any{
    if(this.registerForm.valid){
      ...
      this._registrationService.onRegister('users/register', user).subscribe((data: RegisterModel) => {
          const loginData = {
            email: data.email,
  ...
  ngOnInit() {
    this._loginService.isLoginPage(true);
